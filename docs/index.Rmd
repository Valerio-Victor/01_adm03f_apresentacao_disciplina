...
- **Grupo de WhatsApp:** 
[_INGRESSE NO GRUPO CLICANDO AQUI_](https://chat.whatsapp.com/K0ikt0cd8v8ATr28IQAYTk)
...
cronograma <- data.frame(
  ...
  DIA = c('17/03', '24/03', '31/03', '14/04', '28/04', '05/05', '19/05', '26/05'),
...
cronograma <- data.frame(
  AULA = c(9, 10, 11, 12, 13, 14, 15),
  DIA = c('02/06', '16/06', '23/06', '30/06', '07/07', '14/07', '21/07'),
