...
primeiro_dia <- lubridate::ymd('2024-03-15')

cronograma <- data.frame(
  AULA = c(1, 2, 3, 4, 5, 6, 7, 8, 9),
  DIA = c(format(primeiro_dia,"%d-%m-%Y"),
          format(primeiro_dia+(7*1),"%d-%m-%Y"),
          format(primeiro_dia+(7*3),"%d-%m-%Y"),
          format(primeiro_dia+(7*4),"%d-%m-%Y"),
          format(primeiro_dia+(7*5),"%d-%m-%Y"),
          format(primeiro_dia+(7*6),"%d-%m-%Y"),
          format(primeiro_dia+(7*7),"%d-%m-%Y"),
          format(primeiro_dia+(7*8),"%d-%m-%Y"),
          format(primeiro_dia+(7*9),"%d-%m-%Y")),
...
cronograma <- data.frame(
  ...
  DIA = c(format(primeiro_dia+(7*10),"%d-%m-%Y"),
          format(primeiro_dia+(7*11),"%d-%m-%Y"),
          format(primeiro_dia+(7*12),"%d-%m-%Y"),
          format(primeiro_dia+(7*13),"%d-%m-%Y"),
          format(primeiro_dia+(7*14),"%d-%m-%Y"),
          format(primeiro_dia+(7*15),"%d-%m-%Y"),
          format(primeiro_dia+(7*16),"%d-%m-%Y")),
