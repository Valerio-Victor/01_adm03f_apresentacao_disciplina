...
- **ATENDIMENTO PREVIAMENTE AGENDADO SOBRE ASSUNTOS DA COORDENAÇÃO**:
    ...
    - O agendamento deverá ocorrer com 2 dias de antecedência, não é necessário solicitar e não é necessário avisar.
...
cronograma <- data.frame(
  ...
  SEMANA = c('06/04 e 09/04','13/04 e 16/04','20/04 e 23/04','27/04 e 07/05',
             '11/05 e 14/05','18/05 e 21/05','25/05 e 28/05'),
  ...
  TEMAS = c('Apresentação da Disciplina', 
           ...
           'Nível de Atividade e Mercado de Trabalho',
...
cronograma <- data.frame(
  ...
  SEMANA = c('25/05 e 28/05', '13/07 e 16/07','20/07 e 23/07'),
